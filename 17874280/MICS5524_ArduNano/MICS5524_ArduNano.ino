...
void loop() 
{
  ...
  */
  /*float gasdata1 = mics.getGasData(CH4);
  Serial.print(gasdata1,10);
  Serial.println(" PPM (CH4)");
  delay(1000);

  float gasdata2 = mics.getGasData(C2H5OH);
  Serial.print(gasdata2,10);
  Serial.println(" PPM (C2H5OH)");
  delay(1000);

  float gasdata3 = mics.getGasData(H2);
  Serial.print(gasdata3,10);
  Serial.println(" PPM (H2)");
  delay(1000);*/

  float gasdata4 = mics.getGasData(NH3);
  Serial.print(gasdata4,10);
  Serial.println(" PPM (NH3)");

  /*float gasdata5 = mics.getGasData(CO);
  Serial.print(gasdata5,10);
